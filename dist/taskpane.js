...
module.exports = __webpack_require__.p + "63c3b7954065774e1474.css";
...
Office.onReady(function (info) {
  if (info.host === Office.HostType.Word) {
    ...
    var renderUsageCharts = function renderUsageCharts(stats) {
      ...
      var apiCallsData = dates.map(function (d) {
        return stats.daily[d].apiCalls;
      });
      var cacheHitData = dates.map(function (d) {
        return stats.daily[d].cacheHitTokens;
      });
      var cacheMissData = dates.map(function (d) {
        return stats.daily[d].cacheMissTokens;
      });
      var outputData = dates.map(function (d) {
        return stats.daily[d].completionTokens;
      });
    ...
    btnResetStats === null || btnResetStats === void 0 || btnResetStats.addEventListener("click", function () {
