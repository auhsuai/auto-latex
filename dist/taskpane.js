...
Office.onReady(function (info) {
  if (info.host === Office.HostType.Word) {
    ...
    var editorSettingsToggle = document.getElementById("editor-settings-toggle");
    var editorSettingsContainer = document.getElementById("editor-settings-container");
    var editorSettingsChevron = document.getElementById("editor-settings-chevron");
    editorSettingsToggle === null || editorSettingsToggle === void 0 || editorSettingsToggle.addEventListener("click", function () {
      if (editorSettingsContainer && editorSettingsChevron) {
        var isHidden = editorSettingsContainer.style.display === "none";
